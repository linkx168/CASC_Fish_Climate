...
#data
```{r}
#update filepath for the hived data, with partitioning by state
ia_data <- open_dataset(sources = file.path(), partitioning = c("state")) %>% 
  filter(state == "Iowa")
glimpse(ia_data)
```
...
#write filepath for state specific abundance 
#write_csv(ia_filtered_species, ".csv")
```
