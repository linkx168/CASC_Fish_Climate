...
#UPDATE FILE PATH TO IN DISAGGREGATED DATA FOLDER
...
#READ IN FILEPATH FOR MGLP_FISH_LAKES_12Aug24.csv
...
#READ IN FILEPATH FOR lake_metadata.csv
...
#gear xwalk
#UPDATE WITH FILEPATH FOR gears_by_state.csv
gear_xwalk <- read_csv() %>% 
...
# Add in HALK Ages
```{r}
#UPDATE WITH FILEPATH FOR halked_fish_xwalk.csv
...
write_dataset(dataset = in_data, path = )

#UPDATE WITH FILEPATH OF SAVED PARQUET FILE
in_data <- open_dataset() 
glimpse(in_data)
```
