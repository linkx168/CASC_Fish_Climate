...
#UPDATE FILE PATH TO MI DISAGGREGATED DATA FOLDER
...
#UPDATE WITH FILEPATH TO gears_by_state.csv
gear_xwalk <- read_csv() %>% 
...
write_dataset(dataset = mi_data, path = )

#update with filepath where parquet was saved
