...
#READ FILEPATH FOR MGLP_FISH_LAKES_12Aug24.csv
...
#READ FILEPATH FOR lake_metadata.csv
...
# Adding in HALK ages
```{r}
#read FILEPATH FOR halked_fish_xwalk.csv, generated by b_HALK
...
#write filepath to save
write_dataset(dataset = il_data, path = )

#read in filepath that was saved
il_data <- open_dataset()
