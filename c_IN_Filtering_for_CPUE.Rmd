...
#data
```{r}
#update filepath to hived dataset
in_data <- open_dataset(sources = file.path(), partitioning = c("state")) %>% 
...
#update for state specific saving for abundance file
#write_csv(in_filtered_species, ".csv")
```
